...
if (isset($_GET['did'])) {
  extract($_GET);
  $q="delete from recepie where recepie_id='$did'";
  delete($q);
  alert('  Successfully');
  return redirect('hotel_view_menu.php');
}
if (isset($_GET['uid'])) {
  extract($_GET);
  $q="select * from recepie where recepie_id='$uid'";
  $res=select($q);
}
if (isset($_POST['update'])) {
  extract($_POST);
  $q="update recepie set recepie='$fname',incredienets='$price',details='$qty' where recepie_id='$uid'";
  update($q);
  alert('  Successfully');
  return redirect('hotel_view_menu.php');
  ...
  <body>
   ...
   <li class="nav-item menu-items">
        ...
        <div class="wrapper" style="background-image: url('/static/deliveryboyreg/images/bg-registration-form-3.jpg'); display: flex;flex-direction: column;">
			<div class="inner" style="background-color: black;max-width: 1082px;">
              ...
              <div class="form-holder">
                ...
                <input style="color: white;" size="70" type="text" class="form-control" value="<?php echo $res[0]['recepie'] ?>" name="fname">
                <br>
               
               <label for="">Enter Incredienets:</label>
                <div class="form-holder">
                  <!-- <i class="zmdi zmdi-account-o"></i> -->
                  <input type="text"  value="<?php echo $res[0]['incredienets'] ?>" class="form-control" name="price">
              <br>

                <label for="">Enter Details:</label>
                <div class="form-holder">
                  <!-- <i class="zmdi zmdi-account-o"></i> -->
                  <input type="text"  value="<?php echo $res[0]['details'] ?>" class="form-control" name="qty">
              <br>

              <img src="<?php echo $res[0]['image'] ?>"  width="100"  height="100">
                      ...
                      <th></th>
                              ...
                              <tbody>
                                 <?php 
                                  ...
                                  $q="SELECT * FROM `recepie` INNER JOIN `host`  on recepie.user_id=host.login_id   where login_id='$hid'";
                                  $res=select($q);
                                  $slno=1;
                                  foreach ($res as $row) {
                                  ?>
...
<tr>
                                  ...
                                  <td><a  class="btn btn-success" href="?did=<?php echo $row['recepie_id'] ?>">Delete</a></td>
                                  <td><a  class="btn btn-success" href="?uid=<?php echo $row['recepie_id'] ?>">Edit</a></td>
