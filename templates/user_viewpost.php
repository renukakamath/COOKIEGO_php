...
if (isset($_GET['did'])) {
  ...
  delete($q);
  alert('  Successfully');
  return redirect('user_viewpost.php');
}
if (isset($_GET['uid'])) {
  extract($_GET);
                      ...
                      <th></th>
                              ...
                              <tbody>
                                 <?php 
                                  ...
                                  $q="SELECT * FROM `recepie` INNER JOIN `user` on recepie.user_id=user.login_id  where login_id='$uid'";
                                  $res=select($q);
                                  $slno=1;
                                  foreach ($res as $row) {
                                  ?>
...
<tr>
                                  ...
                                  <td><a class="btn btn-success" href="user_viewrating.php?rid=<?php echo $row['recepie_id'] ?>"> Ratings</a></td>
