...
if (isset($_GET['did'])) {
  ...
  delete($q);
  alert('  Successfully');
  return redirect('userviewotherclass.php');
}
if (isset($_GET['uid'])) {
  extract($_GET);
  ...
  <li class="nav-item nav-category">
        ...
        <div class="wrapper" style="background-image: url('/static/deliveryboyreg/images/bg-registration-form-3.jpg'); display: flex;flex-direction: column;">
			<div class="inner" style="background-color: #191c24;max-width: 1082px;" >
				<form method="post">
					<h3 class="h3">View Other Recepie</h3>
...
<tr>
                                  ...
                                  <td><a href="<?php echo $row['image'] ?>  "   download><img src="<?php echo $row['image'] ?>"   height="100" width="100" ></a></td>

                                  <td><a class="btn btn-success" href="user_addratings.php?rid=<?php echo $row['recepie_id'] ?>">Add Ratings</a></td>
