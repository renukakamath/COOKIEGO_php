...
if (isset($_GET['did'])) {
  ...
  delete($q);
  alert('  Successfully');
  return redirect('viewdeliveryboy.php');
}
if (isset($_GET['uid'])) {
  extract($_GET);
   ...
   <li class="nav-item menu-items">
       ...
       <?php  if (isset($_GET['uid'])) { ?>
        <div class="wrapper" style="background-image: url(deliveryboyreg/images/bg-registration-form-3.jpg'); display: flex;flex-direction: column;">
			<div class="inner" style="background-color: black;max-width: 1082px;color: white">
				<form method="post">
					<h3>Edit Event</h3>
					<div class="form-group">
						<div class="form-wrapper">
							<label for="" class="ll">Enter Event:</label>
							<div class="form-holder">
								<!-- <i class="zmdi zmdi-account-o"></i> -->
								<input type="text" class="form-control"  style="color: white" name="fname" value="<?php echo $res[0]['event'] ?>">
                <br>
                <label for="" class="ll">Enter Details:</label>
                <div class="form-holder">
                  <!-- <i class="zmdi zmdi-account-o"></i> -->
                  <input type="text" class="form-control" style="color: white" name="lname" value="<?php echo $res[0]['details'] ?>">
              <br>
              <label for="" class="ll">Enter Event Date:</label>
              <div class="form-holder">
                
                <input type="text" class="form-control" style="color: white" name="dhouse" value="<?php echo $res[0]['eventdate'] ?>">
                      ...
                      <th>Date </th>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td><a class="btn btn-success" href="?uid=<?php echo $row['event_id'] ?>">Edit</a></td>
                                  <td><a class="btn btn-success" href="?did=<?php echo $row['event_id'] ?>">Delete</a></td>
