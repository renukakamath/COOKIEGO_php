      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar p-0 fixed-top d-flex flex-row">
          <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
            <a class="navbar-brand brand-logo-mini" href="index.html"><img src="entrepreneur/images/logo-mini.svg" alt="logo" /></a>
          </div>
            ...
            <ul class="navbar-nav navbar-nav-right">
              ...
              <li class="nav-item dropdown border-left">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="entrepreneur/images/faces/face4.jpg" alt="image" class="rounded-circle profile-pic">
                    </div>
                    <div class="preview-item-content">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="entrepreneur/images/faces/face2.jpg" alt="image" class="rounded-circle profile-pic">
                    </div>
                    <div class="preview-item-content">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="entrepreneur/images/faces/face3.jpg" alt="image" class="rounded-circle profile-pic">
                    </div>
                    <div class="preview-item-content">
        ...
        <div class="wrapper" style="background-image: url('/static/deliveryboyreg/images/bg-registration-form-3.jpg'); display: flex;flex-direction: column;">
			<div class="inner" style="background-color: black;max-width: 1082px;">
				<form method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						<div class="form-wrapper">
						 <label for="foodcat">Select Category</label>
              ...
              <label for="foodcat">Enter Food Name</label>
              <div class="form-holder">
                <!-- <i class="zmdi zmdi-account-o"></i> -->
                <input style="color: white;" size="70" type="text" class="form-control" value="{{data['r'][0]['food_name']}}" name="fname">
                <br>
               
               <label for="">Enter Price:</label>
                <div class="form-holder">
                  <!-- <i class="zmdi zmdi-account-o"></i> -->
                  <input type="text" value="{{data['r'][0]['price']}}" class="form-control" name="price">
              <br>

                <label for="">Enter Quantity:</label>
                <div class="form-holder">
                  <!-- <i class="zmdi zmdi-account-o"></i> -->
                  <input type="text" value="{{data['r'][0]['quantity']}}" class="form-control" name="qty">
              <br>
        ...
        <div class="wrapper" style="background-image: url('/static/deliveryboyreg/images/bg-registration-form-3.jpg'); display: flex;flex-direction: column;">
			<div class="inner" style="background-color: #191c24;max-width: 1082px;" >
				<form method="post">
					<h3 class="h3">View Payment Details</h3>
